...
-- CreateTable
CREATE TABLE "payer_contact_info" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "payer_contact_info_pkey" PRIMARY KEY ("id")
);

-- CreateIndex
CREATE UNIQUE INDEX "payer_contact_info_payer_id_key" ON "payer_contact_info"("payer_id");
...
-- AddForeignKey
ALTER TABLE "payer_contact_info" ADD CONSTRAINT "payer_contact_info_payer_id_fkey" FOREIGN KEY ("payer_id") REFERENCES "payers"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "payer_contact_info" ADD CONSTRAINT "payer_contact_info_updated_by_id_fkey" FOREIGN KEY ("updated_by_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
