    ...
    <div className="max-w-7xl mx-auto">
      ...
      {provider?.status === 'pending_verification' && (
        <div className="mb-6 rounded-lg border border-amber-300 bg-amber-50 p-4 flex items-start gap-3">
          ...
          <div>
            <h3 className="text-sm font-medium text-amber-800">Account verification in progress</h3>
            <p className="text-sm text-amber-700 mt-1">
              Your account is being reviewed. You can start setting up your profile. Enrollment features will be available once verified.
            </p>
          </div>
        </div>
      )}
